...
define gui.text_font = gui.preference("font", "fonts/GFSDidot-Regular.ttf")
# The text font for buttons
define gui.interface_text_font = gui.preference("interface_font", "fonts/font.ttf")
# The default size of in-game text
define gui.text_size = gui.preference("size", 33)
# The font for character names
define gui.name_text_font = gui.preference("name_font", "fonts/font.ttf")
...
style frame:
    ...
    ##define gui.accent_color = '#7DF9FF'

    ##define gui.hover_color = '#7DF9FF'
style splashscreen:
    font 'fonts/font.ttf'
    xalign 1.0
